      ...
      <main className="min-h-screen bg-gray-100">
        ...
        <div className="w-full bg-black text-white">
          <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <div className="mt-8">
                <a href="#preferences" className="inline-block px-6 py-3 rounded-full bg-gray-700 text-white font-medium shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:bg-gray-800">
                  Start Planning
                </a>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6" id="preferences">
              <h2 className="text-2xl font-semibold text-gray-800 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-gray-600">We help travelers plan their perfect trips with AI-powered recommendations.</p>
              </div>
              <div>
